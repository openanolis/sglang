...
mod test_pd_routing {
    ...
    fn test_epd_encode_grpc_request_format() {
        ...
        use sgl_model_gateway::grpc_client::encoder_proto::EncodeRequest;
    ...
    fn test_epd_grpc_client_construction() {
        // Test gRPC encoder client construction helper
        use sgl_model_gateway::grpc_client::SglangEncoderClient;

        // Test request builder
        let request = SglangEncoderClient::build_encode_request(
            vec!["https://example.com/image.jpg".to_string()],
            "test-req-001".to_string(),
            1,
            0,
            "prefill-host".to_string(),
            vec![8998],
        );
    ...
    async fn test_epd_encode_grpc_client_integration() {
        ...
        let result = SglangEncoderClient::connect("grpc://127.0.0.1:59999").await;
        assert!(
            result.is_err(),
